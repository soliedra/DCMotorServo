...
DCMotorServo::DCMotorServo(uint8_t pin_dir_A, uint8_t pin_dir_B, uint8_t pin_pwm_output_A,uint8_t pin_pwm_output_B, uint8_t pin_encode_1, uint8_t pin_encode_2)
{
  _pin_PWM_output_A = pin_pwm_output_A;
  _pin_PWM_output_B = pin_pwm_output_B;
  ...
  pinMode(_pin_PWM_output_A, OUTPUT);
  pinMode(_pin_PWM_output_B, OUTPUT);
...
void DCMotorServo::run() {
  ...
  _pick_direction();
  analogWrite(_pin_PWM_output_A, _PWM_output);
  analogWrite(_pin_PWM_output_B, _PWM_output);
}
